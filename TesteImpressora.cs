...
{
    public partial class TesteImpressora : Form
    {
        ...
        void ImprimirTeste(List<ItemVenda> itens, Venda venda, Cliente cliente)
        {
        ...
        string FazerLinha1(ItemVenda iv)
        {
        ...
        string FazerLinha2(ItemVenda iv)
        {
            int quantidade = 5;
